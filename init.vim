...
autocmd filetype cpp nnoremap <F2> :w <bar> exec '!g++ -o '.shellescape('%:r')' glad.c -ldl -lglfw '.shellescape('%').' && ./'.shellescape('%:r')<CR>
...
map <F9> :exec '!xfce4-terminal --default-working-directory='.shellescape('%:p')' && disown' <CR>
